...
const Policy = () => {
    ...
    useEffect(() => {
        ...
        const policyApiUrl = `https://premium.treatweb.com/public/api/admin/policies/${id}`;
        // const policyApiUrl = `http://127.0.0.1:9000/api/admin/policies/${id}`;
        axios
            .get(policyApiUrl)
            .then((response) => {
                console.log(response.data.business);
                policy=response.data.business;
                console.log('--');
                console.log(policy);
                // formData=policy;
                policy.each((key,value)=>(
