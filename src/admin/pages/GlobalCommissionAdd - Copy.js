...
const GlobalCommissionAdd = () => {
    ...
    useEffect(() => {
        ...
        // const apiUrl = `http://phpstorm.local:9000/api/admin/global-commissions/options`;
    ...
    const handleSave = () => {
        ...
        // axios.post('http://phpstorm.local:9000/api/admin/global-commissions/store', formDataJSON, {
            headers: {
    ...
    return (
        <Layout title="Global Commission Setting" breadcrumbData={generateBreadcrumbData(RightContent)}>
            <Card bgColor="gray">
                                        ...
                                        partnerData.global_commission_options.engines
                                            ...
                                            .map((engine, index) => (
                                                ...
                                                <tr className="shade" data-index={engine} data-index_={index == '0'}>
                                                    {index === 0 ? <th className="border-b shade p-2">{partnerData.global_commission_options.engines[0].text}
